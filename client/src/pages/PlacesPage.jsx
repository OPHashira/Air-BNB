...
export default function PlacesPage () {
    ...
    const [photolLink, setPhotoLink] = useState('');
    ...
    function inputDescription (text) {
        return (
            <p className="text-gray-500 text-sm">{text}t</p>
        );
    }
    ...
    async function addPhotoByLink (ev) {
        ev.preventDefault();
        const { data: filename } = await axios.post('/upload-by-link', { link: photolLink });
        setAddedPhotos(prev => {
                ...
                <div>
                    <form >
                        ...
                        <div className="flex gap-2">
                            <input value={photolLink} onChange={ev => setPhotoLink(ev.target.value)} type="text" placeholder={'Add using a link .....jpg'} />
